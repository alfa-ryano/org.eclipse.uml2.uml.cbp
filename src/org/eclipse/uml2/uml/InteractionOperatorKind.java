...
public enum InteractionOperatorKind implements Enumerator {
	...
	private static final InteractionOperatorKind[] VALUES_ARRAY = new InteractionOperatorKind[] { SEQ_LITERAL,
			ALT_LITERAL, OPT_LITERAL, BREAK_LITERAL, PAR_LITERAL, STRICT_LITERAL, LOOP_LITERAL, CRITICAL_LITERAL,
			NEG_LITERAL, ASSERT_LITERAL, IGNORE_LITERAL, CONSIDER_LITERAL, };
